        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', gap: '8px', marginTop: '16px' }}>
            ...
            <button
              ...
              style={{ 
                padding: '8px 16px', 
                background: (!messageInput.trim() || !selectedChatId || isApiProcessing) ? '#666' : '#4cafef', 
                color: 'white', 
                border: 'none', 
                borderRadius: '4px',
                cursor: (!messageInput.trim() || !selectedChatId || isApiProcessing) ? 'not-allowed' : 'pointer',
                opacity: (!messageInput.trim() || !selectedChatId || isApiProcessing) ? 0.6 : 1
              }}
            >
              {isApiProcessing ? 'Sending...' : 'Send'}
            </button>
          </div>
          {isApiProcessing && (
            <div style={{ 
